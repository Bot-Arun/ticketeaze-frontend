<script setup>
  ...
  async function adminLogin() {
    try {
      const data = await postData('/admin/login',{
        email:email.value,
        password:pass.value,
      }) 
...
<div class="container p-2">
  <div class="title mt-2 ">
    ...
    <div class="text-center h1 fw-bold mx-1 mx-md-4 mt-4">Admin Login</div>
  </div>
</div>
                ...
                <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                  ...
                  <div class="mx-1 mx-md-4">
                    ...
                    <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                      <button type="submit" class="btn btn-md btn-secondary register-btn" @click="adminLogin()" >Login</button>
                    </div>
